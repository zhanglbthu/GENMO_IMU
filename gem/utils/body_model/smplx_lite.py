...
_BODY_MODEL_RESOURCE_DIR = Path(__file__).parent
...
class SmplxLiteCoco17(SmplxLite):
    ...
    def __init__(self, **kwargs):
        ...
        # Compute mapping
        smplx2smpl = torch.load(_BODY_MODEL_RESOURCE_DIR / "smplx2smpl_sparse.pt")
        COCO17_regressor = torch.load(_BODY_MODEL_RESOURCE_DIR / "smpl_coco17_J_regressor.pt")
...
class SmplxLiteV437Coco17(SmplxLite):
    def __init__(self, **kwargs):
        ...
        # Verts437
        smplx_vids2 = torch.load(_BODY_MODEL_RESOURCE_DIR / "smplx_verts437.pt")
...
class SmplxLiteSmplN24(SmplxLite):
    ...
    def __init__(self, **kwargs):
        ...
        # Compute mapping
        smplx2smpl = torch.load(_BODY_MODEL_RESOURCE_DIR / "smplx2smpl_sparse.pt")
        smpl2joints = torch.load(_BODY_MODEL_RESOURCE_DIR / "smpl_neutral_J_regressor.pt")
